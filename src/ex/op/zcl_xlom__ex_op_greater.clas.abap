CLASS zcl_xlom__ex_op_greater DEFINITION
  PUBLIC FINAL
  CREATE PRIVATE
  ...
  PUBLIC SECTION.
    INTERFACES zif_xlom__ex DATA VALUES name = '>'
                                        type = zif_xlom__ex=>c_type-operation-greater.
    ...
    CLASS-METHODS create
      ...
      RETURNING VALUE(result) TYPE REF TO zcl_xlom__ex_op_greater.
...
CLASS zcl_xlom__ex_op_greater IMPLEMENTATION.
...
*    zif_xlom__ex~type = zif_xlom__ex=>c_type-operation-equal.
  ...
  METHOD create.
    result = NEW zcl_xlom__ex_op_greater( ).
