CLASS zcl_xlom__ex_op_greater_equal DEFINITION
  PUBLIC FINAL
  CREATE PRIVATE
  ...
  PUBLIC SECTION.
    INTERFACES zif_xlom__ex DATA VALUES name = '>='
                                        type = zif_xlom__ex=>c_type-operation-greater_or_equal.
    ...
    CLASS-METHODS create
      ...
      RETURNING VALUE(result) TYPE REF TO zcl_xlom__ex_op_greater_equal.
...
CLASS zcl_xlom__ex_op_greater_equal IMPLEMENTATION.
  ...
  METHOD create.
    result = NEW zcl_xlom__ex_op_greater_equal( ).
