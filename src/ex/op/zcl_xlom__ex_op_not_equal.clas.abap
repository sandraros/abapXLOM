CLASS zcl_xlom__ex_op_not_equal DEFINITION
  PUBLIC FINAL
  CREATE PRIVATE
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      ...
      RETURNING VALUE(result) TYPE REF TO zcl_xlom__ex_op_not_equal.
...
CLASS zcl_xlom__ex_op_not_equal IMPLEMENTATION.
  METHOD constructor.
    zif_xlom__ex~type = zif_xlom__ex=>c_type-operation-not_equal.
