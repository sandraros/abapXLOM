CLASS zcl_xlom__ex_op_lower_equal DEFINITION
  PUBLIC FINAL
  CREATE PRIVATE
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      ...
      RETURNING VALUE(result) TYPE REF TO zcl_xlom__ex_op_lower_equal.
...
CLASS zcl_xlom__ex_op_lower_equal IMPLEMENTATION.
...
*    zif_xlom__ex~type = zif_xlom__ex=>c_type-operation-equal.
  ...
  METHOD create.
    result = NEW zcl_xlom__ex_op_lower_equal( ).
