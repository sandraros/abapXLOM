...
INTERFACE zif_xlom__ex
  ...
  CONSTANTS:
    ...
    BEGIN OF c_type,
      ...
      table          TYPE ty_expression_type VALUE 9,
      table_column   TYPE ty_expression_type VALUE 10,
      table_col_rang TYPE ty_expression_type VALUE 11,
      table_item_spe TYPE ty_expression_type VALUE 12,
      BEGIN OF operation,
